...
const Form = () => {
  ...
  const updateMessageEventHandler = event =>
  ...
  return (
    <>
      <Alert
        ...
        visible={showError}
        text="The enquiry form failed to send, please try again later"
      />
      <Alert
        type={AlertTypes.SUCCESS}
        visible={showSuccess}
        text="Thank you for your enquiry. We aim to reply within 3 working days. Please check your junk mail if you have not received a reply after this time. Thank you for contacting us."
      />
      <form onSubmit={submitFormEventHandler}>
        ...
        <div className="buttons">{!isloading ? <Button>Submit</Button> : <LoadingIcon />}</div>
      </form>
    </>
  );
};
